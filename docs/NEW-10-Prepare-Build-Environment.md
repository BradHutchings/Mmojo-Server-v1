...
- [Set Timezone](NEW-11-Set-Timezone.md)
- [Install Dependencies](NEW-12-Install-Dependencies.md)
- [Set up Cross Compile - aarch64 on x86_64](NEW-13-Setup-up-Cross-Compile-aarch64-on-x86_64.md)
- [Set up Cross Compile - x86_64 on aarch64](NEW-Setup-up-Cross-Compile-x86_64-on-aarch64.md)
